(ns marketentry.phase
  "Phase 0->3 staged rollout for the CRI market-entry compliance
  actor.
  ...
  real SICOP portal package and submitting a real portal registration
  are the two real-world acts this actor performs; both are always a
  human market-entry operator's call.
  `marketentry.governor`'s `:actuation/draft-filing`/
